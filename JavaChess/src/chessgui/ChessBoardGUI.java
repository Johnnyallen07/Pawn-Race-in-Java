...
public class ChessBoardGUI {
    ...
    public static JPanel createChessBoard(JFrame f, Map<Point, Pair<PieceName, PieceColor>> pointPieceNameandColorMap){
...
//                b.setPreferredSize(new Dimension(64, 64));
                ...
                pointPieceNameandColorMap.put(coord, new Pair<PieceName, PieceColor>(PieceName.grid, PieceColor.NULL));
